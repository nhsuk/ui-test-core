...
class Interrogator(object):
    ...
    def is_image_visible_by_javascript(self, page_element):
        ...
        :param page_element: list of images
        ...
        element_tag = self.find.element(page_element).tag_name
        element_image_src = self.get_attribute(page_element, "src")
        if element_tag == 'svg' and element_image_src is None:
            return page_element.is_displayed()
        ...
        return self.driver.execute_script(script, page_element)
